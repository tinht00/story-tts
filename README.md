...
- Provider ưu tiên hiện tại: `edge_tts` qua `tts_service`
...
- `docs/realtime-runtime.md`: luồng runtime realtime và các case lỗi đã ghi nhận
...
- Các case lỗi runtime đã chốt cùng triệu chứng, nguyên nhân gốc và cách verify được ghi riêng trong `docs/realtime-runtime.md`.

## Tài liệu điều hướng
- [AGENTS.md](D:/Tinht00_Workspace/VibeCode/story-tts/AGENTS.md)
- [.agent/HOW_TO_USE.md](D:/Tinht00_Workspace/VibeCode/story-tts/.agent/HOW_TO_USE.md)
- [.agent/project_settings.md](D:/Tinht00_Workspace/VibeCode/story-tts/.agent/project_settings.md)
- [.agent/rules/project_rules.md](D:/Tinht00_Workspace/VibeCode/story-tts/.agent/rules/project_rules.md)
- [docs/architecture-v1.md](D:/Tinht00_Workspace/VibeCode/story-tts/docs/architecture-v1.md)
- [docs/realtime-runtime.md](D:/Tinht00_Workspace/VibeCode/story-tts/docs/realtime-runtime.md)
- [docs/decision-log.md](D:/Tinht00_Workspace/VibeCode/story-tts/docs/decision-log.md)
- [docs/ai-digest.md](D:/Tinht00_Workspace/VibeCode/story-tts/docs/ai-digest.md)
- [docs/TODO.md](D:/Tinht00_Workspace/VibeCode/story-tts/docs/TODO.md)
