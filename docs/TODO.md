...
- Việc còn thiếu: Verify trực tiếp trên UI với truyện dài nhiều chapter để kiểm tra panel segment nhiều chapter, restart từ segment, nút `Đọc từ bôi chọn`, và highlight từng chữ khớp nhịp audio thực tế.
